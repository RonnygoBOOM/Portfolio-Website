  ...
  return (
    ...
    <ParallaxLayer
        ...
        <p>
          ...
          much a work in progress, but I will keep improving and adding content
          week by week as I continue on my growth journey as a web developer.
        </p>
        <br />
        <p>
          As a teacher and a scientist, I have a growth mindset, and a strong
          passion for learning. I am hyped to have found a career that allows me
          to challenge myself with difficult problems, collaborate with others,
          and continuously learn, grow, and adapt to a constantly-evolving
          environment. I would love to hear from you! Check out my <a className="text-link" href="/Contact">Contact</a> page to send me a message.
        </p>
        <br />
        ...
        <p>
          ...
          then, I have been following tutorials, coming up with my own creative
          ideas, and building projects every day. I often live-stream my
          progress to help hold myself accountable for my own growth and
          learning.
        </p>
      </Parallax>
      </div>
